...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        arabic: ['Cairo', 'DIN Next Arabic', 'sans-serif'],
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(to right, #2E7D32, #66BB6A)',
      }
    },
    container: {
      center: true,
  ...
  plugins: [
    // Recommended for automatic RTL/LTR flip utility generation
