...
ALTER TABLE IF EXISTS ONLY public."WebOrder" DROP CONSTRAINT IF EXISTS "WebOrder_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."WebOrderItem" DROP CONSTRAINT IF EXISTS "WebOrderItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."WebOrderItem" DROP CONSTRAINT IF EXISTS "WebOrderItem_orderId_fkey";
ALTER TABLE IF EXISTS ONLY public."TechnicalSpec" DROP CONSTRAINT IF EXISTS "TechnicalSpec_productId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."QuotationItem" DROP CONSTRAINT IF EXISTS "QuotationItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."Promotion" DROP CONSTRAINT IF EXISTS "Promotion_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."Product" DROP CONSTRAINT IF EXISTS "Product_categoryId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProductSpec" DROP CONSTRAINT IF EXISTS "ProductSpec_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProductPackaging" DROP CONSTRAINT IF EXISTS "ProductPackaging_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProductImage" DROP CONSTRAINT IF EXISTS "ProductImage_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProductFeature" DROP CONSTRAINT IF EXISTS "ProductFeature_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProductCertification" DROP CONSTRAINT IF EXISTS "ProductCertification_productId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."Client" DROP CONSTRAINT IF EXISTS "Client_repId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientPayment" DROP CONSTRAINT IF EXISTS "ClientPayment_repId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientPayment" DROP CONSTRAINT IF EXISTS "ClientPayment_clientId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientOrder" DROP CONSTRAINT IF EXISTS "ClientOrder_repId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientOrder" DROP CONSTRAINT IF EXISTS "ClientOrder_clientId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientInteraction" DROP CONSTRAINT IF EXISTS "ClientInteraction_repId_fkey";
ALTER TABLE IF EXISTS ONLY public."ClientInteraction" DROP CONSTRAINT IF EXISTS "ClientInteraction_clientId_fkey";
...
DROP INDEX IF EXISTS public."WebOrder_userId_idx";
DROP INDEX IF EXISTS public."WebOrder_status_idx";
DROP INDEX IF EXISTS public."WebOrder_isQuotation_idx";
DROP INDEX IF EXISTS public."WebOrder_createdAt_idx";
DROP INDEX IF EXISTS public."User_email_key";
DROP INDEX IF EXISTS public."ShippingZone_name_en_key";
DROP INDEX IF EXISTS public."ShippingZone_name_ar_key";
DROP INDEX IF EXISTS public."Quotation_userId_idx";
DROP INDEX IF EXISTS public."Quotation_status_idx";
DROP INDEX IF EXISTS public."QuotationItem_quotationId_idx";
DROP INDEX IF EXISTS public."PromoCode_isActive_idx";
DROP INDEX IF EXISTS public."PromoCode_code_key";
DROP INDEX IF EXISTS public."Product_stock_idx";
DROP INDEX IF EXISTS public."Product_slug_key";
DROP INDEX IF EXISTS public."Product_name_ar_idx";
DROP INDEX IF EXISTS public."Product_is_featured_idx";
DROP INDEX IF EXISTS public."Product_createdAt_idx";
DROP INDEX IF EXISTS public."Product_categoryId_idx";
DROP INDEX IF EXISTS public."Product_activePromotionId_key";
DROP INDEX IF EXISTS public."PageContent_pageSlug_key";
DROP INDEX IF EXISTS public."PageContentHistory_pageSlug_savedAt_idx";
DROP INDEX IF EXISTS public."News_slug_key";
DROP INDEX IF EXISTS public."Client_status_idx";
DROP INDEX IF EXISTS public."Client_repId_idx";
DROP INDEX IF EXISTS public."Client_name_idx";
DROP INDEX IF EXISTS public."Client_createdAt_idx";
DROP INDEX IF EXISTS public."ClientPayment_repId_idx";
DROP INDEX IF EXISTS public."ClientPayment_clientId_idx";
DROP INDEX IF EXISTS public."ClientInteraction_repId_idx";
DROP INDEX IF EXISTS public."ClientInteraction_clientId_idx";
DROP INDEX IF EXISTS public."Category_slug_key";
DROP INDEX IF EXISTS public."Cart_userId_key";
DROP INDEX IF EXISTS public."CartItem_cartId_productId_weightVariant_key";
ALTER TABLE IF EXISTS ONLY public._prisma_migrations DROP CONSTRAINT IF EXISTS _prisma_migrations_pkey;
ALTER TABLE IF EXISTS ONLY public."WebOrder" DROP CONSTRAINT IF EXISTS "WebOrder_pkey";
ALTER TABLE IF EXISTS ONLY public."WebOrderItem" DROP CONSTRAINT IF EXISTS "WebOrderItem_pkey";
ALTER TABLE IF EXISTS ONLY public."User" DROP CONSTRAINT IF EXISTS "User_pkey";
ALTER TABLE IF EXISTS ONLY public."TechnicalSpec" DROP CONSTRAINT IF EXISTS "TechnicalSpec_pkey";
...
ALTER TABLE IF EXISTS ONLY public."ProductSpec" DROP CONSTRAINT IF EXISTS "ProductSpec_pkey";
ALTER TABLE IF EXISTS ONLY public."ProductPackaging" DROP CONSTRAINT IF EXISTS "ProductPackaging_pkey";
ALTER TABLE IF EXISTS ONLY public."ProductImage" DROP CONSTRAINT IF EXISTS "ProductImage_pkey";
ALTER TABLE IF EXISTS ONLY public."ProductFeature" DROP CONSTRAINT IF EXISTS "ProductFeature_pkey";
ALTER TABLE IF EXISTS ONLY public."ProductCertification" DROP CONSTRAINT IF EXISTS "ProductCertification_pkey";
ALTER TABLE IF EXISTS ONLY public."PageContent" DROP CONSTRAINT IF EXISTS "PageContent_pkey";
ALTER TABLE IF EXISTS ONLY public."PageContentHistory" DROP CONSTRAINT IF EXISTS "PageContentHistory_pkey";
ALTER TABLE IF EXISTS ONLY public."OutboxEvent" DROP CONSTRAINT IF EXISTS "OutboxEvent_pkey";
...
ALTER TABLE IF EXISTS ONLY public."ClientPayment" DROP CONSTRAINT IF EXISTS "ClientPayment_pkey";
ALTER TABLE IF EXISTS ONLY public."ClientOrder" DROP CONSTRAINT IF EXISTS "ClientOrder_pkey";
ALTER TABLE IF EXISTS ONLY public."ClientInteraction" DROP CONSTRAINT IF EXISTS "ClientInteraction_pkey";
...
ALTER TABLE IF EXISTS public."WebOrderItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."WebOrder" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TechnicalSpec" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ShippingZone" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Promotion" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."PromoCode" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductSpec" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductPackaging" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductImage" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductFeature" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductCertification" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public."ClientPayment" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ClientOrder" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ClientInteraction" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ClientContact" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public."WebOrder_id_seq";
DROP SEQUENCE IF EXISTS public."WebOrderItem_id_seq";
DROP TABLE IF EXISTS public."WebOrderItem";
DROP TABLE IF EXISTS public."WebOrder";
DROP TABLE IF EXISTS public."User";
DROP SEQUENCE IF EXISTS public."TechnicalSpec_id_seq";
DROP TABLE IF EXISTS public."TechnicalSpec";
DROP TABLE IF EXISTS public."SiteSettings";
DROP SEQUENCE IF EXISTS public."ShippingZone_id_seq";
...
DROP SEQUENCE IF EXISTS public."PromoCode_id_seq";
DROP TABLE IF EXISTS public."PromoCode";
DROP SEQUENCE IF EXISTS public."Product_id_seq";
DROP SEQUENCE IF EXISTS public."ProductSpec_id_seq";
DROP TABLE IF EXISTS public."ProductSpec";
DROP SEQUENCE IF EXISTS public."ProductPackaging_id_seq";
DROP TABLE IF EXISTS public."ProductPackaging";
DROP SEQUENCE IF EXISTS public."ProductImage_id_seq";
DROP TABLE IF EXISTS public."ProductImage";
DROP SEQUENCE IF EXISTS public."ProductFeature_id_seq";
DROP TABLE IF EXISTS public."ProductFeature";
DROP SEQUENCE IF EXISTS public."ProductCertification_id_seq";
DROP TABLE IF EXISTS public."ProductCertification";
DROP TABLE IF EXISTS public."Product";
DROP TABLE IF EXISTS public."PageContentHistory";
DROP TABLE IF EXISTS public."PageContent";
DROP TABLE IF EXISTS public."OutboxEvent";
...
DROP SEQUENCE IF EXISTS public."ClientPayment_id_seq";
DROP TABLE IF EXISTS public."ClientPayment";
DROP SEQUENCE IF EXISTS public."ClientOrder_id_seq";
DROP TABLE IF EXISTS public."ClientOrder";
DROP SEQUENCE IF EXISTS public."ClientInteraction_id_seq";
DROP TABLE IF EXISTS public."ClientInteraction";
DROP SEQUENCE IF EXISTS public."ClientContact_id_seq";
...
COPY public."Client" (id, name, company, industry, notes, "createdAt", "updatedAt", lat, lng, "locationUrl", "mainPhone", "repId", "secondaryPhone", "storeImage", "storeType", "creditLimit", "outstandingBalance", status, governorate) FROM stdin;
3	محل الصقور 		\N		2026-04-18 17:28:29.387	2026-05-16 13:45:30.336	\N	\N	https://www.google.com/maps?q=31.034061,30.467496	0150175002	\N		/uploads/crm/1776534488851-images_(2).jfif	سوبرماركت	0	0	LEAD	\N
4	سوبر ماركت البركة		\N		2026-05-16 13:41:32.413	2026-05-16 19:32:05.285	31.0311277	30.460912	https://www.google.com/maps?q=31.0311277,30.460912	01013713596	\N		/uploads/crm/1778938770697-Screenshot_2026-05-13_21-07-17.png	سوبرماركت	0	1455	LEAD	\N
\.
...
COPY public."ClientInteraction" (id, "clientId", type, notes, date, "nextFollowUp", "repId", "createdAt", "updatedAt") FROM stdin;
1	4	VISIT	تم زيارة العميل ومناقشة تفاصيل طلبيته القادمة وعرض الأسعار الجديد. العميل أبدى اهتماماً كبيراً	2026-05-17 00:00:00	\N	cmmokssfm0001rtf0sdndqttp	2026-05-17 12:53:40.598	2026-05-17 12:53:40.598
\.
...
COPY public."ClientOrder" (id, "clientId", "repId", status, "totalAmount", notes, "rejectionReason", "expectedDate", "createdAt", "updatedAt", "invoiceFile") FROM stdin;
3	4	cmmokssfm0001rtf0sdndqttp	DELIVERED	1455	366	\N	\N	2026-05-16 00:00:00	2026-05-16 19:17:30.69	\N
\.
...
COPY public."ClientPayment" (id, "clientId", amount, "paymentDate", method, notes, "repId", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."News" (id, slug, title_ar, title_en, excerpt_ar, excerpt_en, content_ar, content_en, category, tags, featured_image, image_alt, meta_title, meta_description, is_featured, is_published, published_at, scheduled_at, "createdAt", "updatedAt", gallery) FROM stdin;
...
14	33fsdf	يسسسي	33fsdf	يسسي	dddd	<p>يسسي</p>	\N	news	\N	/uploads/upload_1779024551238_6jr0ac.png	\N	\N	\N	f	t	2026-05-17 13:29:46.347	\N	2026-05-17 13:29:46.35	2026-05-17 13:29:46.35	{/uploads/upload_1779024547447_355pdu.png}
\.
...
COPY public."OrderItem" (id, "orderId", "productId", quantity, "unitPrice", subtotal, "customItemName") FROM stdin;
7	3	14	1	745	745	\N
8	3	17	1	710	710	\N
\.
...
15	joory-vegetable-ghee-11kg-tin	سمنة نباتي جوري 11 كيلو صفيح	Joory Vegetable Ghee - 11kg Tin	سمنة نباتي جوري بجودة استثنائية ونكهة غنية، الخيار الأمثل للمطابخ الاحترافية لضمان قوام مثالي ومذاق لا يقاوم.	Joory vegetable ghee offers exceptional quality and rich flavor, making it the perfect choice for professional kitchens to ensure ideal texture and irresistible taste.	تعد سمنة جوري النباتية شريكك المثالي في الطهي والخبز، حيث تتميز بقوامها المتجانس وقدرتها العالية على تحمل درجات الحرارة المرتفعة، مما يجعلها مثالية للقلي والتحمير وإعداد الحلويات الشرقية الفاخرة. بفضل تركيبتها المتطورة، تمنح أطباقك نكهة غنية ورائحة زكية تعزز من جودة منتجاتك النهائية وتضمن رضا عملائك الدائم.\nتأتي في عبوة صفيح اقتصادية بوزن 11 كيلو، مصممة خصيصاً لتلبية احتياجات المطاعم والفنادق وصناع الحلويات الكبار. تتميز بفترة صلاحية طويلة وسهولة في التخزين، كما أنها خالية من الكوليسترول، مما يوفر توازناً مثالياً بين الأداء المهني العالي والقيمة الغذائية المطلوبة في صناعة الأغذية الاحترافية.	Joory vegetable ghee is your ideal partner in cooking and baking, characterized by its consistent texture and high smoke point, which makes it perfect for frying, sautéing, and preparing premium oriental sweets. Thanks to its advanced formulation, it gives your dishes a rich flavor and aromatic scent that enhances the quality of your final products and ensures lasting customer satisfaction.\nIt comes in an economical 11kg tin, specifically designed to meet the needs of restaurants, hotels, and large-scale confectioners. It features a long shelf life and ease of storage, and is cholesterol-free, providing a perfect balance between high professional performance and the nutritional value required in the professional food industry.	\N	\N	/uploads/upload_1777335835582_tcht5w.png	780	صفيحة 11 كيلو	11 kg weight plate 	t	t	\N	\N	\N	8	\N	\N	\N	\N	2026-04-28 00:31:41.966	2026-05-16 13:30:11.458	99
\.
...
COPY public."WebOrder" (id, "customerName", "customerEmail", "customerPhone", governorate, city, "shippingAddress", "totalAmount", status, "createdAt", "updatedAt", "paymentMethod", "shippingFee", "userId", "discountAmount", "promoCode", notes, "isQuotation") FROM stdin;
25	زكي السيد زكي	\N	01501750002	Beheira	Damanhour	الشارع المعهد الديني	855	PROCESSING	2026-05-16 13:30:11.585	2026-05-16 13:32:51.596	COD	75	\N	0	\N	\N	f
7	محمد الشباسي	admin@elsalam.com	01013713596	Cairo	\N	البحيرة دمنهور شارع المعهد الديني	3630	SHIPPED	2026-04-21 22:45:25.387	2026-05-17 14:24:28.439	COD	100	\N	10	\N	مصاريف شحن زيادة	f
\.
