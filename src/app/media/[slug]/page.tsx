            ...
            <article className="pt-28 pb-16">
                <Container className="max-w-4xl">
                    ...
                    {article.gallery && article.gallery.length > 0 && (
                        <ScrollReveal>
                            <div className="mb-12">
                                <h3 className="text-2xl font-black text-gray-900 mb-6">{t.media.categories.factory_tours || "معرض الصور"}</h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                    {article.gallery.map((img, i) => (
                                        <div key={i} className="group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow aspect-square bg-gray-100">
                                            <img
                                                src={img}
                                                alt={`${title} - Image ${i + 1}`}
